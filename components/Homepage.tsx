...
export default function FintechDashboard() {
  ...
  const adminPhone = "2349019818087";
  ...
  const handleRefresh = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        "https://mufappdata.com.ng/app/api/user/app-refresh/index.php",
        {
          method: "POST",
  ...
  const handleTransferCashback = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://mufappdata.com.ng/app/api/user/cashback-transfer/index.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ phone }),
      ...
      >
          ...
          onClick={async () => {
            ...
            window.open(
              `https://wa.me/${adminPhone}?text=${encodeURIComponent(
                "Hello, I am using the mufappdata App. I would like to suggest a new service: "
              )}`,
              "_blank"
            );
          }}
        ...
        <div
          ...
          onClick={async () => {
            ...
            window.open(
              `https://wa.me/${adminPhone}?text=${encodeURIComponent(
                `Hello Admin, I am ${userName}. I need assistance with the mufappdata App.`
              )}`,
              "_blank"
            );
          }}
