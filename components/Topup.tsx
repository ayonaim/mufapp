...
export default function FundAccountPage() {
  ...
  const submitManualVerification = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://mufappdata.com.ng/app/api/fund-wallet/manual/index.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <h4 className="font-bold">OPay/Smart Cash</h4>
                </div>
                <div className="text-right">
                  <p className="text-xs text-zinc-500">Account Name</p>
                  <h4 className="font-bold">Yusuf</h4>
                </div>
              </div>
              <div
              ...
              >
                ...
                <Button
                  onClick={() => copyToClipboard("6100165594", "admin_acc")}
                  variant="ghost"
                  size="icon"
